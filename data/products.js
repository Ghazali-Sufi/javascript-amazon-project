...
export class Clothing extends Product {
  ...
  constructor(productDetails) {
    // basically calls the constructor of the parent class which is the Product
...
export function loadProductsFetch() {
  const promise = fetch("https://supersimplebackend.dev/products")
    ...
    .then((productsData) => {
      ...
      console.log('Unexoected error. Please try again later.');
    }); 
...
// the fun we passed loadproducts, is known as a callback, because we are giving at a function to run or call in the future
